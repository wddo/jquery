    ...
    var wddoObj = function () {
        ...
        function up() {
            ...
            if (isRepeat) {
                ...
                checkLimit();
                currentIdx = count = (count - jump > min) ? count - jump : (isFirst) ? max : min; //modify 2.2.4, (count > min) -> (count - jump > min)
            }
        ...
        function down() {
            ...
            if (isRepeat) {
                ...
                //일반형, 양끝에선 정지
                currentIdx = count = (max > count + jump) ? count + jump : (isFirst) ? min : max; //modify 2.2.4, (max > count) -> (max > count + jump)
            }
