...
*   1.2.1 (2019.05.09) : ios 에서 .css('transform'); null 반환 대응
*   1.2.2 (2019.11.15) : options.pagination, options.autoplay === undefined 수정
*
    ...
    var SwiperTemplate = (function ($) {
        var wddoObj = function () {
            ...
            function swiperChange(data, event) {
                ...
                if (trans !== undefined && trans !== null && trans !== 'none' && trans.length > 5 && $.isArray(matrixToArray(trans))) { //add 1.2.1 trans !== null //ios fix
            ...
            function migrationVer4(options) {
                ...
                if (options.pagination !== undefined && options.pagination.length > 0) { //modify 1.2.2
                    options.pagination = {
                        el: '.swiper-pagination'
                    };    
                }

                if (options.autoplay !== undefined && options.autoplay.length > 0) { //modify 1.2.2
                    options.autoplay = {
